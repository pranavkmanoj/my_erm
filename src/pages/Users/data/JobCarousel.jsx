    ...
    return (
        ...
        >
            <div className="overflow-hidden">
                ...
                >
                    {jobs.map((job) => (
                        <div key={job._id} className="w-full flex-shrink-0 px-4">
                            <div className="bg-[#2a2a2a] rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
                                <h3 className="text-xl font-bold text-[#f7f7f7] mb-2">{job.jobTitle}</h3>
                                <p className="text-[#fb5607] font-medium mb-1">{job.companyName}</p>

                                <div className="flex flex-wrap gap-2 mb-3">
                                    <span className="bg-[#333] text-[#f7f7f7] px-3 py-1 rounded-full text-sm">
                                        {job.jobLocation}
                                    </span>
                                    <span className="bg-[#333] text-[#f7f7f7] px-3 py-1 rounded-full text-sm">
                                        {job.jobType}
                                ...
                                <div className="mb-4">
                                    <p className="text-[#f7f7f7] text-sm mb-1">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    <button
                                        className="px-6 py-2 bg-[#fb5607] text-white font-medium rounded-lg hover:bg-[#ea033f] transition-colors"
            ...
            {jobs.length > 1 && (
                <>
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-[#fb5607] p-2 rounded-full text-white hover:bg-[#ea033f] transition-colors"
                    >
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-[#fb5607] p-2 rounded-full text-white hover:bg-[#ea033f] transition-colors"
                    >
